...
<body>
  <div class="main">
      <div class="position">
          <h3>当前位置：</h3>
          <p><a href="#">厂商首页</a><a href="runInfo.jsp" target="Rcontent">&gt平台运行信息</a><a href="#">&gt平台详细信息</a></p>
      </div>
	         ...
	         <table border="1" class="table_text">
	        	<tr>
   				...
   				<tr>
   					...
   					<td>
   						<ul>
   							<li class="check_info"><a href="runInfoDetailed.jsp" target="Rcontent">查看</a></li>
