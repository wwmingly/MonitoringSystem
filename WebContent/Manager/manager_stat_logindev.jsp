        		...
        		<div class="form">
        			<table border="1" class="table_text">
        				...
        				<tr>
        					...
        					<td>
        						<ul>
        							<li><a href="#"><b class="form_icon_del"></b>停用</a></li>
        							<li><a href="#"><b class="form_icon_mod"></b>启用</a></li>
        							<li><a href="manager_stat_logindev.all.jsp"><b class="form_icon_check"></b>查看</a></li>
        						</ul>
        					</td>
        				</tr>
        				<tr>
