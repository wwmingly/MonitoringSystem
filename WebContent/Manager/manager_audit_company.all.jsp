...
<div class="main main_body">
	<div class="content index_content">
			<div class="position">
    			...
    			<h3>当前位置：</h3>
    			<p>
    				<a href="#">厂商信息管理</a> <a href="manager_audit_company.jsp">&gt厂商信息审核</a><a href="#">&gt查看详情</a>  			   
    			</p>
    		</div>
        	...
        	<div class="operation">
        		...
        		<ul class="detailed_list">
        			<li>
        				<i>序号：</i>
        				<div class="detailed_content">01</div>
        			</li>
        			<li>
        				<i>厂商名称：</i>
        				...
        				<i>审核状态：</i>
        				<div class="detailed_content">未审核</div>
        			</li><li>
        				<i>负责人：</i>
        			...
        			<li>
        				...
        				<div class="detailed_content">
        					<input type="button" class="the_editor" id="" value="审 核">
